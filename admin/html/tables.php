        ...
        <main class="p-4 md:p-8">
                        ...
                        <tr data-id="<?php echo $table['id']; ?>">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center gap-2">
                                    <!-- Đặt bàn -->
                                    <button type="button"
                                            class="btn-action book-table px-3 py-2 rounded bg-emerald-500 text-white hover:bg-emerald-600"
                                            title="Đặt bàn">
                                        Đặt bàn <i class="fa-solid fa-calendar-check"></i>
                                    </button>

                                    <!-- Sửa -->
                                    <button type="button"
                                            class="btn-action edit-table px-3 py-2 rounded bg-yellow-500 text-white hover:bg-yellow-600"
                                            title="Chỉnh sửa">
                                        Chỉnh sửa <i class="fa-solid fa-pen"></i>
                                    </button>

                                    <!-- Xóa -->
                                    <button type="button"
                                            class="btn-action delete-table px-3 py-2 rounded bg-red-500 text-white hover:bg-red-600"
                                            title="Xóa">
            ...
            <div id="table-modal" class="modal">
                <div class="modal-content">
                    ...
                    <h2 id="modal-title">Chỉnh sửa</h2>
                    <form id="table-form">
