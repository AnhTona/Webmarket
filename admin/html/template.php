            ...
            <ul class="space-y-2">
                ...
                if ($userRole === 'ADMIN') {
                    ...
                    $menu_items = [
                            ...
                            ['page' => 'admin_staff.php', 'icon' => 'fa-user-shield', 'label' => 'Quản lý Admin/Staff'],
                            ['page' => 'reports.php', 'icon' => 'fa-chart-line', 'label' => 'Báo cáo & thống kê'],
                    ];
                } else {
                    // STAFF - Chỉ thấy Quản lý đơn hàng
                    $menu_items = [
                            ['page' => 'orders.php', 'icon' => 'fa-receipt', 'label' => 'Quản lý đơn hàng'],
                    ];
                }
            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="notification-dropdown" id="notification-dropdown">
                    ...
                    <?php if (!empty($notifications)): ?>
                        <div class="notification-footer border-t p-3 text-center">
                            <a href="../js/notifications_refresh.js" class="text-sm brand-primary hover:underline">
                ...
                <div class="flex items-center space-x-2 cursor-pointer">
                    <div class="text-sm font-medium text-gray-800 hidden sm:block">
                        <?php
                        echo isset($_SESSION['user_name']) ? htmlspecialchars($_SESSION['user_name']) : 'Admin.HTrà';
                        // Hiển thị vai trò
                        $roleLabel = $userRole === 'ADMIN' ? '(Admin)' : '(Staff)';
                        echo ' <span class="text-xs text-gray-500">' . $roleLabel . '</span>';
                        ?>
                    </div>
                    <img class="h-10 w-10 rounded-full object-cover border-2 border-red-300"
                         src="https://placehold.co/40x40/8f2c24/ffffff?text=<?= $userRole === 'ADMIN' ? 'AD' : 'ST' ?>"
                         alt="Avatar">
                </div>
            </div>
        </header>
...
<!-- Global Scripts -->
<script src="../js/notification_refresh.js"></script>
