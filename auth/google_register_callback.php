<?php
// auth/google_register_callback.php
...
require_once __DIR__ . '/../controller/controller_register.php'; // có hàm handleGoogleRegister(array $profile)

if (!isset($_GET['state'], $_GET['code']) ||
    !hash_equals($_SESSION['google_register_state'] ?? '', $_GET['state'])) {
...
// 3) Gọi controller để xử lý đăng ký (tạo user mới, session…)
handleGoogleRegister($profile);
