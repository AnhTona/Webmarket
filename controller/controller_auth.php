...
if (isset($_GET['code'])) {
    ...
    $controller->handleOAuthLogin($googleProfile);
}

// Facebook OAuth callback example:
if (isset($_GET['code'])) {
    ...
    $controller = new OAuthController();
    $controller->handleOAuthLogin($facebookProfile);
}

// Protect pages:
OAuthController::requireLogin();

// Get current user:
$user = OAuthController::getCurrentUser();
